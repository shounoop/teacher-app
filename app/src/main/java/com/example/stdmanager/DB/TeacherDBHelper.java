...
public class TeacherDBHelper extends SQLiteOpenHelper {
    ...
    public void createDefaultTeachersIfNeed() {
        ...
        if (count == 0) {
            Teacher Teacher1 = new Teacher(1, "Trịnh Thị Vân Anh", "123456");
            Teacher Teacher2 = new Teacher(2, "Nguyễn Mạnh Sơn", "123456");
            Teacher Teacher3 = new Teacher(3, "Nguyễn Mạnh Hùng", "123456");
